...
Recomendações
Investigar o que ocorreu especificamente em fevereiro e março (projeto pontual? renovação de contrato? erro de lançamento?), já que concentram praticamente todo o prejuízo do ano.
Priorizar a revisão de custos fixos (como licenças e distribuição) antes de cortar variáveis, já que representam a maior fatia do orçamento.
